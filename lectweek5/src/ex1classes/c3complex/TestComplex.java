...
public class TestComplex {
    ...
    void program() {
        // Many constructors for convenience
        Complex c1 = new Complex(1, 2);  // Create objects of type Complex
        ...
        // New objects returned, chained calls possible
        out.println(c1.sub(c2).equals(new Complex(4, 7)));
        out.println(c1.add(c1).add(c1).equals(new Complex(3, 6)));
